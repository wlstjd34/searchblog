...
class ControllerSearchBlogTest {
    ...
    public void init() {
        ...
        Mockito.when(blogOpenApi.get(headers, "GET", "https://dapi.kakao.com/v2/search/blog?size=10&query=abc&sort=accuracy&page=2"))
        ...
        Mockito.when(blogOpenApi.get(headers, "GET", "https://dapi.kakao.com/v2/search/blog?size=10&query=abc&sort=accuracy&page=3"))
        ...
        Mockito.when(blogOpenApi.get(headers, "GET", "https://dapi.kakao.com/v2/search/blog?size=10&query=abc&sort=accuracy&page=4"))
