...
class ControllerSearchBlogTest {
    ...
    public void init() throws SocketTimeoutException {
        ...
        Mockito.when(blogOpenApi.get(headers, "GET", apiUrl + "?size=10&query=abc&sort=accuracy&page=1"))
        ...
        Mockito.when(blogOpenApi.get(headers, "GET", apiUrl + "?size=10&query=abc&sort=accuracy&page=2"))
        ...
        Mockito.when(blogOpenApi.get(headers, "GET", apiUrl + "?size=10&query=abc&sort=accuracy&page=3"))
        ...
        Mockito.when(blogOpenApi.get(headers, "GET", apiUrl + "?size=10&query=abc&sort=accuracy&page=4"))
        ...
        Mockito.when(blogOpenApi.get(headers, "GET", apiUrl + "?size=10&query=abc&sort=accuracy&page=5"))
