...
class ControllerSearchBlogTest {
    ...
    public void init() throws SocketTimeoutException {
        ...
        Mockito.when(openApiCaller.get(headers, "GET", apiUrl + "?size=10&query=abc&sort=recency&page=5"))
    ...
    @Test
    @DisplayName("GET /search Parameter 유효성 검사 성공 테스트 - accuracy")
    public void controllerTest_getRightParam_sorting_accuracy() throws Exception {
        // when
    ...
    @Test
    @DisplayName("GET /search Parameter 유효성 검사 성공 테스트 - recency")
    public void controllerTest_getRightParam_sorting_recency() throws Exception {
        // when
        mockMvc.perform(get("/search")
                        .param("query", "abc")
                        .param("sorting", "recency")
                        .param("page", "5")
                        .param("size", "10"))
                .andExpect(status().isOk());
    }
    ...
    @Test
    @DisplayName("GET /search Parameter 유효성 검사 실패 테스트 - sorting")
    public void controllerTest_getWrongParam_sorting() throws Exception {
        // when
        mockMvc.perform(get("/search")
                        .param("query", "abc")
                        .param("sorting", "abc")
    ...
    @Test
    @DisplayName("GET /search Parameter 유효성 검사 실패 테스트 - page < 1")
    public void controllerTest_getWrongParam_smallPage() throws Exception {
        // when
        mockMvc.perform(get("/search")
                        .param("query", "abc")
                        .param("sorting", "accuracy")
    ...
    @Test
    @DisplayName("GET /search Parameter 유효성 검사 실패 테스트 - page > 50")
    public void controllerTest_getWrongParam_largePage() throws Exception {
        // when
        mockMvc.perform(get("/search")
                        .param("query", "abc")
                        .param("sorting", "accuracy")
    ...
    @Test
    @DisplayName("GET /search Parameter 유효성 검사 실패 테스트 - size < 0")
    public void controllerTest_getWrongParam_smallSize() throws Exception {
        // when
        mockMvc.perform(get("/search")
                        .param("query", "abc")
                        .param("sorting", "accuracy")
    ...
    @Test
    @DisplayName("GET /search Parameter 유효성 검사 실패 테스트 - size > 50")
    public void controllerTest_getWrongParam_largeSize() throws Exception {
        // when
        mockMvc.perform(get("/search")
                        .param("query", "abc")
                        .param("sorting", "accuracy")
